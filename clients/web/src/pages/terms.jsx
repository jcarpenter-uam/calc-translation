  ...
  return (
    <div className="max-w-3xl mx-auto w-full">
      ...
      <article className="prose dark:prose-invert lg:prose-xl">
        ...
        <ul>
          <li>
            <span className="font-semibold">{t("authorized_use_title")}</span>{" "}
            {t("authorized_use_text")}
          </li>
          <li>
            <span className="font-semibold">{t("confidentiality_title")}</span>{" "}
            {t("confidentiality_text")}
          </li>
        </ul>
        <p>
          <span className="font-semibold">{t("prohibited_actions_title")}</span>{" "}
