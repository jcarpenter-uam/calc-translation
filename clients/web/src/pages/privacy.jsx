  ...
  return (
    <div className="max-w-3xl mx-auto w-full">
      ...
      <article className="prose dark:prose-invert lg:prose-xl">
        ...
        <ul>
          <li>
            <span className="font-semibold">{t("service_provider_title")}</span>{" "}
            {t("service_provider_text")} <a href="https://soniox.com">Soniox</a>{" "}
          ...
          <li>
            <span className="font-semibold">{t("sharing_purpose_title")}</span>{" "}
        ...
        <h2>
          <span className="font-semibold">{t("storage_security_title")}</span>
        </h2>
        <ul>
          <li>
          ...
          <li>
            <span className="font-semibold">{t("data_retention_title")}</span>{" "}
        ...
        <ul>
          <li>
            <span className="font-semibold">{t("app_installation_title")}</span>{" "}
